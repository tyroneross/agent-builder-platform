...
// Cloud-tier model IDs.
// Anthropic IDs verified against the runtime's published model list (Haiku 4.5
// and Sonnet 4.6 are the current parse/synthesis tiers as of 2026-05).
// OpenAI IDs (gpt-5, gpt-5-mini) are TAG:UNVERIFIED — knowledge cutoff is
// 2026-01; if the IDs are stale at runtime the lane returns a 404 envelope
// and the cascade advances to the next provider. Override via env if needed.

...
- Research depth factor: 5. Claims are separated into verified, inferred, unsupported, and needs-review states.

## Structure

- Word table factor: 3. More tables improve scanability when the artifact contains schedule, claims, and learning data.

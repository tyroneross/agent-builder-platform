 ...
 */
async function tryStep({ step, system, userMsg, timeoutMs, onChunk, runDir, nodeKey, attempt }) {
  const t0 = Date.now();
 ...
 */
async function runNodeCascade({ node, cascade, system, userMsg, timeoutMs, onEvent, runDir }) {
  let attempt = 0;
  let lastErr = null;
